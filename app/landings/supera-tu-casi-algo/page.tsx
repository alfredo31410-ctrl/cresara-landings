    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        <div className={styles.copy}>
          ...
          <div className={styles.badge}>Evento gratuito · En vivo</div>
          ...
          <p className={styles.eyebrow}>PASO 1 DE 2</p>
          <h1>
            Da el primer paso para <em>volver a elegirte</em> y recuperar tu paz.
          </h1>
          <p className={styles.subtitle}>
            Un taller gratuito de 3 días para entender por qué te cuesta soltar y
            comenzar a recuperar claridad emocional.
          </p>
        </div>
        ...
        <aside className={styles.formCard}>
          ...
          <p className={styles.formIntro}>
            Completa tus datos. Después pasarás al último paso: entrar al grupo
            oficial de WhatsApp.
          </p>
          <RegistrationForm />
          <p className={styles.privacy}>
            ...
            <br />
            Cero spam. Solo información relacionada con el taller.
          </p>
        </aside>

        <ul className={styles.benefits}>
          <li>Entiende lo que te mantiene esperando.</li>
          <li>Identifica el ciclo que prolonga la confusión.</li>
          <li>Recupera claridad para tomar decisiones.</li>
          <li>Da un primer paso para volver a elegirte.</li>
        </ul>
